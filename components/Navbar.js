  ...
  return (
    <>
      <header className="text-gray-600 body-font">
        ...
        <Link href={'/'} rel=”noopener noreferrer” className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">KnowYourWeather</Link>
